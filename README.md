...
> Все сведения приведенные в данном документе относятся к работе выполненной именно мной. Работа к выполнению которых я отношения не имел здесь не указаны! В случае чужих работ в которых я принимал участие как соисполнитель это указывается явным образом с указанием конкретных задач.
